            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
                    ...
                    <ScrollAnimation animation="fade-up" delay={0.2} className="h-full">
                        <div className="bg-card border border-border rounded-xl p-6 flex flex-col items-center text-center hover:shadow-lg transition-all h-full">
                    ...
                    <ScrollAnimation animation="fade-up" delay={0.4} className="h-full">
                        <div className="bg-card border border-border rounded-xl p-6 flex flex-col items-center text-center hover:shadow-lg transition-all h-full">
                            ...
                            <div className="mt-4 text-xs text-muted-foreground bg-muted p-2 rounded w-full font-mono text-left min-h-[5rem] flex items-center">
