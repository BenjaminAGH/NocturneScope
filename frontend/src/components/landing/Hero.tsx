      ...
      <Container className="flex flex-wrap ">
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-4xl mb-8">
            ...
            <p className="py-5 text-xl leading-normal text-foreground lg:text-xl xl:text-2xl">
              NocturneScope es una plataforma de monitoreo y análisis de redes
              diseñada para automatizar tareas de seguridad y facilitar la
              gestión de infraestructuras de red.
            </p>

            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                href="https://github.com/BenjaminAGH/HoneyNet-Service"
                target="_blank"
                rel="noopener"
