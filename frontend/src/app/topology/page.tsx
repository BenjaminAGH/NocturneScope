...
function TopologyEditor() {
            ...
            try {
                ...
                if (recentAlerts.length > 0) {
                    setNodes((nds) => nds.map((n) => {
                        // ... existing logic for action/email
    ...
    // ... onConnect logic (add notification support if needed, though generic works)
